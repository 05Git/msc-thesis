...
# diambra run -g python record.py --cfg _ --use_controller --num_eps_to_record _ --agent_path _ --rec_folder _ --username _ --deterministic
...
def main(
    ...
    recording_settings.dataset_path = os.path.join(base_path, ep_recording_path, settings.game_id)
